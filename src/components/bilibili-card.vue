    ...
    <ShadowRoot>
        ...
        <div class="video-holder">
            <a class="default-flex full-width" target="_blank" rel="noopener noreferrer" :href="url"
                ...
                <div class="disable-event cover-box" style="float: left;">
                    ...
                    <div v-if="backgroundImage" class="cover-img video-cover-img" :style="{ backgroundImage }"></div>
                    <div v-if="hasDurationFlag" class="video-subtitle">
                        <div class="video-duration">{{ duration || defaultDuration }}</div>
                    </div>
                </div>
                <div class="disable-event video-content-container">
                    ...
                    <div class="video-card-info" style="display: flex;">
                        <div v-for="value in infos" :class="['cover-info-item', value.type]" style="display: flex;">
                            ...
                            <span class="single-ellipsis num-info">{{ value.text }}</span>
                        </div>
                    </div>
                    <div class="video-card-bottom" style="display: flex;">
                        <label v-if="name" class="card-text-label">{{ name }}</label>
                        <div class="view-flex default-flex align-center author-info" style="display: flex;">
                            ...
                            <span class="view-flex single-ellipsis author-name">{{ author || defaultAuthor }}</span>
                        </div>
                    </div>
                </div>
            </a>
